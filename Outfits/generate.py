...
credentials = service_account.Credentials.from_service_account_file(r'C:\Users\stuti\Downloads\project-505463-0d4e9f8e2203.json')
...
def get_similar_products_file(
    ...
    for result in results:
        ...
        other_product = ans.product

        #print('Score(Confidence): {}'.format(result.score))
        #print('Image name: {}'.format(result.image))
        starting = other_product.name.find('_') + 1
        sim_product_id = other_product.name[starting:]
        #print(product.name)
        #print(product_id)
    ...
    try:
        #print(sim_product_id)
        return sim_product_id
    except:
        return 0
